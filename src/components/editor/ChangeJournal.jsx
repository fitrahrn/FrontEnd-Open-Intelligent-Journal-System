...
const ChangeJournal = () => {
  ...
  const getJournalById = async () => {
    const journalData = await api.get(`https://backend-oijs-77pyv5kz2q-et.a.run.app/journal/${journal}`);
  ...
  const updateJournal = async (event) => {
    ...
    try {
      await api.patch(`https://backend-oijs-77pyv5kz2q-et.a.run.app/journal/${journal}`, formData, {
