...
const ArticlePublication = ({data}) => {
    ...
    const getIssue = async () => {
        ...
        const response = await api.get(`https://backend-oijs-77pyv5kz2q-et.a.run.app/issue/id/${issueId}`)
        setIssue(response.data);
    };
    const getContributors = async () => {
        const response = await api.get(`https://backend-oijs-77pyv5kz2q-et.a.run.app/contributors/article/${article_id}`)
        setContributors(response.data);
    }
    const getArticleById = async () => {
        const article = await api.get(`https://backend-oijs-77pyv5kz2q-et.a.run.app/article/${article_id}`);
